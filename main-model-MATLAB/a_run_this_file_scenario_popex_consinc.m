...
% check if scenario 4 needs to be activated
scenario_4 = 1;
scenario_4 = 0;
if scenario_4 == 1
    PopulationExplosion = [1 1];
    ConsumptionIncrease = [1 1];
end
...
%%%%%%%%%%%%%%%%%%%%%%%Example%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The following parameters show two different  scenario

% Scenario 1: No Population Explosion, Consumption Increase, No Power
% Plant, Discharge fee included

% Scenario 2: No Population Explosion, Consumption Increase, Power
% Plant, Discharge fee included
...
for i = 1:ns
    ...
    % Execute the model and store the outputs of the model
        [store_output{i}]= b_main_model_file(Modelselection(i),PopulationExplosion(i),ConsumptionIncrease(i),power_plant(i),tfinal,bioenergy(i),i,pISHH_var(i),theta_var(i),khat_var(i));
